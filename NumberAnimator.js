...
*
*
* Ключ параметра-объекта конструктора класса:
...
*   enableDebugger [false] — включение в браузере JS-дебаггера при ошибках
*
* ****************
*
...
* ****************
*
* break() — метод обрывает выполнение анимации и останавливает его на том значении, которое оказалось последним.
...
*   При желании можно добавить вызов этой функции в toValue() после this.break()
*
* ****************
*
